...
| T4 | Investor account takeover | Med — **lockout + rate limit done (1.3a); httpOnly cookie sessions done (1.3b)**; MFA/verify/reset pending | ✅ account lockout + IP rate limit (1.3a); ✅ httpOnly cookie sessions (1.3b); MFA, email verify, reset flow (1.3c/1.3d); security notifications (2); device/session management (later) |
