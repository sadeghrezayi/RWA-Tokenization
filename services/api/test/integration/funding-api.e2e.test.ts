...
describe("Funding API (e2e, real Postgres)", () => {
  ...
  beforeAll(async () => {
    ...
    process.env.FUNDING_BANK_NAME = "E2E Test Bank";
    process.env.FUNDING_ACCOUNT_HOLDER = "Tokenization Platform (test)";
    process.env.FUNDING_ACCOUNT_NUMBER = "IR000000000000000000000001";
